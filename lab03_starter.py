...
while not isValid:
    ...
    combatStrength = input("Enter your combat Strength: (Number between 1-6) ")
    isValid = combatStength.isnumeric() and int(combatStrength) >= 1 and int(combatStrength) <= 6
...
while not isValid:
    print("Error: Input must be a number")
    mCombatStrength = input("Enter the monster Strength: (Number between 1-6) ")
    isValid = combatStength.isnumeric() and int(mCombatStrength) >= 1 and int(mCombatStrength) <= 6
